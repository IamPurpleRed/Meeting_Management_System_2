...
insert into `使用者`(`姓名`,`性別`,`個人電話`,`Email`,`帳號`,`密碼`,`身分`, `管理員` ) values('塗峻翔','男','0910382139','a1085541@mail.nuk.edu.tw','a1085541','123','業界專家','非管理員');
insert into `使用者`(`姓名`,`性別`,`個人電話`,`Email`,`帳號`,`密碼`,`身分`, `管理員` ) values('周昕瑜','女','1234567890','a1085517@mail.nuk.edu.tw','a1085517','123','系助理','管理員');
insert into `使用者`(`姓名`,`性別`,`個人電話`,`Email`,`帳號`,`密碼`,`身分`, `管理員` )values('柯柏熏','男','0987654321','a1081259@mail.nuk.edu.tw','a1085560','123','學生代表','非管理員');
insert into `使用者`(`姓名`,`性別`,`個人電話`,`Email`,`帳號`,`密碼`,`身分`, `管理員` )values('林子閎','男','1111111111','a1085516@mail.nuk.edu.tw','a1085516','123','系上老師','非管理員');
insert into `使用者`(`姓名`,`性別`,`個人電話`,`Email`,`帳號`,`密碼`,`身分`, `管理員` ) values('陳泓銘','男','2222222222','a1085511@mail.nuk.edu.tw','a1085511','123','校外老師','非管理員');
